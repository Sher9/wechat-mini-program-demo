import { tsFormatTime } from '../../../utils/util'
Page({
    data: {
        showButton: false,
        imglist: [
    ...
    onOpen(e) {
        ...
        this.setData({ timeFlag: flag, datetimeShow: true })
    },
    //确定时间
    confirm(e) {
        this.setData({
            datetimeShow: false,
            ['formData.happenTime']: tsFormatTime(e.detail, 'Y-M-D h:m')
        })
    },
    //关闭时间选择器
    cancel() {
    ...
    feedback() {
        this.setData({ feedbackShow: true })
    },
    onFeedbackClose() {
